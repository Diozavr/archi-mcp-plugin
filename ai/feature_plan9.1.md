...
1) Обновить OpenAPI
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: довести и переименовать файл.
...
2) Расширить `JsonReader` массивными методами
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: реализовать и покрыть тестами.
...
3) Ввести пакетные DTO в `core.types.*`
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: реализовать классы и компиляцию.
...
4) Изменить Core: переход на массивы
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: имплементация, базовые тесты.
...
5) Обновить HTTP‑хендлеры
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: имплементация и ручная проверка через curl.
...
6) Тестирование
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: реализовать сценарии и прогнать локально/в CI.
...
7) Синхронизация описаний для LLM
   ...
   - Статус: [todo]
   - Сделано: —
   - Осталось: выполнить после обновления OpenAPI.
...
- 1) OpenAPI: Статус [todo] — Сделано: — — Осталось: внести изменения, проверить.
- 2) JsonReader: Статус [todo] — Сделано: — — Осталось: реализовать API массива и тесты.
- 3) DTO: Статус [todo] — Сделано: — — Осталось: реализовать *Item и *Cmd.
- 4) Core: Статус [todo] — Сделано: — — Осталось: пакетные методы и проверки.
- 5) Handlers: Статус [todo] — Сделано: — — Осталось: парсинг массивов и ответы.
- 6) Tests/smoke: Статус [todo] — Сделано: — — Осталось: обновить и прогнать.
- 7) MCP server.py: Статус [todo] — Сделано: — — Осталось: синхронизировать описания параметров.
